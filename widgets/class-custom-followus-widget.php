...
add_action( 'widgets_init', 'bermondseyelectronics_followus_widget' );

/**
 * Register the Follow Us Widget
 */
function bermondseyelectronics_followus_widget() {
...
class Followus extends WP_Widget {
    ...
    function __construct(){
        parent::__construct(
                'followus', // Base ID
                __( 'Bermondsey Electronics - Follow Us', 'bermondseyelectronics' ), // Name
                array('description' => __( 'Custom follow us widget', 'bermondseyelectronics' )) // Args
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        if( bermondseyelectronics_check_acf_activation() ) {
...
<?php
    ...
    ?>
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'bermondseyelectronics' ); ?></label> 
